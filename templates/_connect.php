<?php if (isset($_SESSION['user'])): ?>
    <div class="current-user">
        <div class="current-avatar" style="<?php echo retrieveAvatarUrl($_SESSION['user']['id']); ?>"></div>
    ...
    <?php if (0 < count($_SESSION['user']['friends'])): ?>
        <ul class="current-user-friends">
            <?php foreach ($_SESSION['user']['friends'] as $friend): ?>
                <li>
                    <a href="index.php?user=<?php echo $friend['code']; ?>" data-toggle="tooltip" title="<?php echo $friend['nom']; ?>" class="friend-img" style="<?php echo retrieveAvatarUrl($friend['id']); ?>" data-placement="right"></a>
                </li>
            <?php endforeach; ?>
        </ul>
    <?php endif; ?>
